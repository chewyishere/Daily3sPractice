...
function BlendCharacterGui( blendMesh ) {
	...
	controls.stop = function() {
		...
		var stopEvent = new CustomEvent( 'stop-animation', getAnimationData()  );
	...
	controls[ 'run to walk' ] = function() {
		
		controls.crossfade( 'run', 'idle' );
